...
function addBookMark(isread) {
    
    isread.classList = ('readitsticker');
    p = document.createElement('p');
    p.textContent = 'Read!';
    p.classList = 'inside';
    isread.appendChild(p);
}

function addButton(isntread) {
    isntread.classList = ('pressifreadbutton');
